...
if($i_id!="")
{
	...
	if(isset($_POST['submit'])=="update")
	{
		...
		$upd="UPDATE items SET i_image='".$new_file_name."',i_nm='".$name."',i_price='".$price."',tot_qty='".$qty."' WHERE i_id=".$_GET['i_id'];
;
		mysqli_query($upd);
		//$s_id=$_GET['s_id'];
...
<td><input type="text" name="name" size="27" value="<?php echo $i_nm; ?>" /></td>
</tr>

<tr>
<td height="50" style="font-size:18px">Item Image : </td>
<td>
<input type="image" name="i1" src="../admin/images/<?php echo $i_image; ?>." height="100" width="100"/>

<input type="hidden" name="h1" value="<?php echo $i_image; ?>" />
<br />
...
<td><input type="text" name="price" size="27"  value="<?php echo $i_price; ?>" /></td>
</tr>
